const ShreeJeeLegalProfile = () => {
  return (
    <div className="pt-24   bg-gray-50 min-h-screen font-montserrat relative">
      <div className=" absolute inset-0 bg-slate-300 bg-opacity-30 blur-sm"></div>
      <header className=" text-white p-6  shadow-md relative z-10">
        <div className=" container mx-auto text-center"></div>
      </header>

      <main className="container mx-auto p-8 relative z-10 max-w-4xl overflow-y-auto h-[80vh]">
        <div className="grid grid-cols-1 gap-6">
          <section className="bg-white p-6 shadow-md rounded-lg">
            <h2 className="text-2xl font-bold mb-4 text-center">Advocates</h2>
            <ul className="list-disc pl-6 text-lg text-center">
              <li>Mr. Rachit Sharma</li>
              <li>Mr. Shashank Pancholi</li>
              <li>Mr. Hanumant Singh Shekhawat</li>
            </ul>
          </section>
          <section className="bg-white p-6 shadow-md rounded-lg">
            ...
            <p className="text-justify">
              Our core practice areas are Arbitration & Dispute Resolution,
              Capital Market, Private Equity, Corporate & Commercial Laws,
              Corporate Governance, Dispute Resolution Consultancy, E commerce,
              Foreign Direct Investment, Insolvency & Bankruptcy, Joint venture
              & Technical Collaborations, FEMA Consultancy, Corporate
              Negotiations, Legal Risk Management, Legal Due Diligence,
              Compromise and Arrangement, Private Equity & Venture Capital,
              Privatization & Disinvestments, Project & Corporate Finance, Real
              Estate, Corporate Restructuring, Regulatory Approvals, Taxation
              (Direct & Indirect & International), Drafting of agreements, Legal
              documentation, Valuation, Benami & Money Laundering Litigation.
              Our presence is before various Courts, Tribunal, forums and
              statutory bodies viz. Rajasthan High Court, District Court,
              Commercial Court, Arbitral Tribunals, National Company Law
              Tribunal (NCLT)/National Company Law Appellate Tribunal (NCLAT),
              Debt Recovery Tribunal / Debt Recovery Appellate Tribunal
              (DRT/DRAT), Income Tax Appellate Tribunal (ITAT), Customs Excise
              and Service Tax Appellate Tribunal (CESTAT), Central
              Administrative Tribunal (CAT), Consumer Forum including National
              Consumer Dispute Redressal Commission (NCDRC), Micro Small
              Enterprises Facilitation Council, Real Estate regulatory Authority
              (RERA),Tax Board, Enforcement Directorate.
            </p>
          </section>
          ...
          <section className="bg-white p-6 shadow-md rounded-lg">
            ...
            <address className="text-lg text-gray-700 text-center">
              <p>
                Ground Floor, H-15, Chitranjan Marg, C-Scheme, Jaipur-302001,
                Rajasthan
              </p>
...
export default ShreeJeeLegalProfile;
